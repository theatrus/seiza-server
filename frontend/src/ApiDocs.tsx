  ...
  return <main className="api-docs-page">
    ...
    <div className="api-layout">
      ...
      <div className="api-content">
        ...
        <DocSection id="integrations" eyebrow="APPLICATION INTEGRATIONS" title="macOS, Python, N.I.N.A., Siril, and persistent clients.">
          <p>Use Seiza as a native desktop app, embed its Rust-backed Python API, connect existing imaging software to the pre-built CLI, or keep a persistent client attached to this queued service.</p>
          <h3>Seiza for macOS: native browsing and plate solving</h3>
          <p><a href="https://github.com/theatrus/seiza-mac">Seiza for macOS</a> is a fast native SwiftUI and AppKit application powered by the Seiza Rust libraries. The signed and notarized universal download supports Apple silicon and Intel on macOS 15 or later. It opens FITS, JPEG, PNG, and TIFF files and folders; provides native thumbnails, header and image-statistics inspection, and on-demand blind solving; and renders the WCS grid, field center, named stars, deep-sky catalogs, transients, comets, and asteroids directly over the image.</p>
          <div className="api-note"><strong>Quick Look included</strong><span>The app bundles a FITS Quick Look preview extension for Finder and other system Quick Look clients. Download the current DMG from <a href="https://github.com/theatrus/seiza-mac/releases/latest">Seiza for macOS releases</a>. Previewing does not need catalogs; solving uses a complete catalog directory selected in the app’s Settings.</span></div>
