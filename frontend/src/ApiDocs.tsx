    ...
    <div className="api-layout">
      ...
      <div className="api-content">
        ...
        <DocSection id="integrations" eyebrow="APPLICATION INTEGRATIONS" title="Desktop apps, Photoshop, PSF Guard, Python, N.I.N.A., and Siril.">
          ...
          <p><a href="https://github.com/theatrus/xisf-photoshop/releases/latest">Download both formats</a> as a Windows x64 installer or plugin ZIP, or a Developer ID signed and notarized universal macOS ZIP. Close Photoshop before installing, then restart it. The Windows installer is currently unsigned. Import defaults are under <strong>Help → About Plug-In → FITS/XISF</strong> on Windows and <strong>Photoshop → About Plug-In → FITS/XISF</strong> on macOS.</p>
          <div className="api-note"><strong>Keep the scientific originals</strong><span>16-bit import rescales the image range and loses absolute scale and precision. Plugin saves flatten pixels and do not preserve WCS, acquisition headers, or other source metadata. Use the original FITS or XISF for later plate solving and scientific analysis; see the <a href="https://github.com/theatrus/xisf-photoshop#supported-image-workflow">plugin workflow and limits</a>.</span></div>
