    ...
    <div className="api-layout">
      ...
      <div className="api-content">
        ...
        <DocSection id="resumable-uploads" eyebrow="TUS 1.0" title="Upload large images in resumable parallel parts.">
          <p>The web application uses the same durable TUS flow. It uploads up to three chunk-aligned parts concurrently for files larger than 32 MiB using the TUS concatenation extension; smaller files use a single stream. Session manifests and chunks survive API restarts. Local storage streams final assembly to disk, while S3 uses native multipart copies without routing the completed image back through the API process.</p>
